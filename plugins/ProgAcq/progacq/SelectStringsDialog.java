...
public class SelectStringsDialog extends JDialog implements ActionListener {
	...
	public static void doInstance(JFrame owner, Vector<String> left, Vector<String> right, WindowListener done)
	{
	...
	public SelectStringsDialog(JFrame owner, Vector<String> leftList, Vector<String> rightList)
	{
	...
	public void actionPerformed(ActionEvent e) {
		if(">".equals(e.getActionCommand())) {
			...
			transferItems(left, ((DefaultListModel)left.getModel()).toArray(), right);
		} else if("<".equals(e.getActionCommand())) {
			transferItems(right, right.getSelectedValues(), left);
		} else if("<<".equals(e.getActionCommand())) {
			transferItems(right, ((DefaultListModel)right.getModel()).toArray(), left);
			...
			moveItems(right, right.getModel().getSize() - right.getMaxSelectionIndex() - 1);
