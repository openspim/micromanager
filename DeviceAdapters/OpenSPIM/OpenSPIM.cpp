...
MODULE_API MM::Device* CreateDevice(const char* deviceName)
{
   ...
   {
#ifdef WIN32
		MessageBox(NULL, "The OpenSPIM device adapter (mmgr_dal_OpenSPIM.dll) has been deprecated in favor of the PicardStage device adapter.\nPlease use the Fiji updater to obtain this new device adapter and update your Micro-Manager configurations accordingly.\nSee http://openspim.org/Downloads#Initial_hardware_configuration for detailed instructions.", "Deprecation Warning", MB_OK);
#else
		somehow_show_a_message();
#endif
		deprecated = true;
   }
