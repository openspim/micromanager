...
public class ZCalibrator {
   ...
   */
   ...
   public void fitFunction() {
      ...
      try {
         RealPointValuePair result = opt.optimize(maxIterations_, mvcx, GoalType.MINIMIZE, params0_);
      ...
      try {
         RealPointValuePair result = opt.optimize(maxIterations_, yvcx, GoalType.MINIMIZE, params0_);
         paramsOut = result.getPoint();
      } catch (java.lang.OutOfMemoryError e) {
         throw (e);
      } catch (Exception e) {
   ...
   public double getZ(double wx, double wy) {  
      ...
      try {
         RealPointValuePair result = opt.optimize(maxIterations_, mz, GoalType.MINIMIZE, params0_);
         paramsOut = result.getPoint();
      } catch (java.lang.OutOfMemoryError e) {
         throw (e);
      } catch (Exception e) {
